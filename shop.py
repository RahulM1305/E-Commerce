...
def laptopCall():
    ...
    name_laptop6=Label(lf_laptop6,text="Apple 2023 MacBook Pro Laptop M2 Max chip",font="arial 9",justify="center").grid(row=1,column=0)
    ...
    options_laptop1=["Deep Purple","Gold","Silver","Space Black"]
    options_laptop2=["Starlight","Midnight","Red"]
    options_laptop3=["Blue","Midnight","Starlight","Red","Purple","Yellow"]
    options_laptoplf_laptop4=["Green","Midnight","Starlight","Red","Blue","Pink"]
    options_laptop5=["Dark Storm","Fearless Flame"]
    options_laptop6=["Green","Phantom Black","Phantom White"]
    options_laptop7=["Dark Red","Green","Phantom Black","Phantom White"]
    options_laptop8=["Chrome Silver"]
    options_laptop9=["Eternal Green","Titan Black","Marble Odyssey"]
    options_laptop10=["Mars Orange","Cosmic Black"]
    ...
    def AddS1():
        ...
        op=messagebox.askyesno("Purchase Confirmation","Are you sure that you want to add this item to the cart?")
        if op:
            laptop_list.append(["Acer Predator Helios Neo 16 Gaming Laptop 13th Gen Intel Core i7 Processor",1970,"1,970",Spaces(40-len("Acer Predator Helios Neo 16 Gaming Laptop 13th Gen Intel Core i7 Processor"))])
    ...
    def AddS2():
        ...
        op=messagebox.askyesno("Purchase Confirmation","Are you sure that you want to add this item to the cart?")
        if op:
            laptop_list.append(["HP Laptop 15s",160,"160",Spaces(40-len("HP Laptop 15s"))])
    ...
    def AddS3():
        ...
        op=messagebox.askyesno("Purchase Confirmation","Are you sure that you want to add this item to the cart?")
        if op:
            laptop_list.append(["MSI GF63 Thin",550,"550",Spaces(40-len("MSI GF63 Thin"))])
    ...
    def AddS4():
        ...
        op=messagebox.askyesno("Purchase Confirmation","Are you sure that you want to add this item to the cart?")
        if op:
            laptop_list.append(["Dell Inspiron 3525 ",350,"350",Spaces(40-len("Dell Inspiron 3525 "))])
    ...
    def AddS5():
        ...
        op=messagebox.askyesno("Purchase Confirmation","Are you sure that you want to add this item to the cart?")
        if op:
            laptop_list.append(["[SmartChoice] Lenovo IdeaPad 3",980,"980",Spaces(40-len("[SmartChoice] Lenovo IdeaPad 3"))])
    ...
    price_laptoplf_laptop=Label(lf_laptop4,text="Price: Rs.350",font="arial 9 bold").grid(row=2,column=0)
