...
def HeadphoneCall():
    ...
    label_qty_Headphone1=Label(lf_Headphone1,text="Qty:",bd=1,font="arial 9",justify="left").place(x=5,y=178)
    label_qty_Headphone2=Label(lf_Headphone2,text="Qty:",bd=1,font="arial 9",justify="left").place(x=5,y=178)
    label_qty_Headphone3=Label(lf_Headphone3,text="Qty:",bd=1,font="arial 9",justify="left").place(x=5,y=178)
    label_qty_Headphone4=Label(lf_Headphone4,text="Qty:",bd=1,font="arial 9",justify="left").place(x=5,y=178)
    label_qty_Headphone5=Label(lf_Headphone5,text="Qty:",bd=1,font="arial 9",justify="left").place(x=5,y=178)
    label_qty_Headphone6=Label(lf_Headphone6,text="Qty:",bd=1,font="arial 9",justify="left").place(x=5,y=178)
...
def laptopCall():
    ...
    name_laptop1=Label(lf_laptop1,text="GM Purist KW 202 Cricket Bat",font="arial 9",justify="center").grid(row=1,column=0,padx=13)
    name_laptop2=Label(lf_laptop2,text="GTS Dezir Cricket Leather Ball",font="arial 9",justify="center").grid(row=1,column=0)
    name_laptop3=Label(lf_laptop3,text="Yonex GR 303 Badminton Racquet",font="arial 9",justify="center").grid(row=1,column=0)
    name_laptop4=Label(lf_laptop4,text="Strauss Maxis Pro Shuttlecock",font="arial 9",justify="center").grid(row=1,column=0)
    name_laptop5=Label(lf_laptop5,text="Stag 4 Star Table Tennis Kit",font="arial 9",justify="center").grid(row=1,column=0,padx=14)
    name_laptop6=Label(lf_laptop6,text="Cockatoo CTM14A 2.5HP",font="arial 9",justify="center").grid(row=1,column=0)
    name_laptop6=Label(lf_laptop6,text="Treadmill with Auto-Incline",font="arial 9",justify="center").grid(row=2,column=0)
    name_laptop7=Label(lf_laptop7,text="Aurion HEX Rubber Coated Cast",font="arial 9",justify="center").grid(row=1,column=0,padx=4)
    name_laptop7=Label(lf_laptop7,text="Iron Hexagonal Dumbbells for",font="arial 9",justify="center").grid(row=2,column=0)
    name_laptop7=Label(lf_laptop7,text="Professional Exercise",font="arial 9",justify="center").grid(row=3,column=0)
    name_laptop8=Label(lf_laptop8,text="SPORTAL Foldable Multi Bench",font="arial 9",justify="center").grid(row=1,column=0)
    name_laptop8=Label(lf_laptop8,text="Press Workout Machine",font="arial 9",justify="center").grid(row=2,column=0)
    name_laptop9=Label(lf_laptop9,text="Reach Air Bike Exercise Cycle",font="arial 9",justify="center").grid(row=1,column=0,padx=12)
    name_laptop10=Label(lf_laptop10,text="RMOUR Filled Heavy Punch Bag",font="arial 9",justify="center").grid(row=1,column=0,padx=5)
    price_laptop1=Label(lf_laptop1,text="Price: Rs.1,970",font="arial 9 bold").grid(row=2,column=0)
    price_laptop2=Label(lf_laptop2,text="Price: Rs.160",font="arial 9 bold").grid(row=2,column=0)
    price_laptop3=Label(lf_laptop3,text="Price: Rs.550",font="arial 9 bold").grid(row=2,column=0)
    price_laptop4=Label(lf_laptop4,text="Price: Rs.350",font="arial 9 bold").grid(row=2,column=0)
    price_laptop5=Label(lf_laptop5,text="Price: Rs.980",font="arial 9 bold").grid(row=2,column=0)
    price_laptop6=Label(lf_laptop6,text="Price: Rs.28,990",font="arial 9 bold").grid(row=3,column=0)
    price_laptop7=Label(lf_laptop7,text="Price: Rs.949",font="arial 9 bold").grid(row=4,column=0)
    price_laptop8=Label(lf_laptop8,text="Price: Rs.6,799",font="arial 9 bold").grid(row=3,column=0)
    price_laptop9=Label(lf_laptop9,text="Price: Rs.6,999",font="arial 9 bold").grid(row=2,column=0)
    price_laptop10=Label(lf_laptop10,text="Price: Rs.2,999",font="arial 9 bold").grid(row=2,column=0)
    def AddS1():
        global laptop_list
        op=messagebox.askyesno("Purchase Confirmation","Are you sure that you want to add this item to the cart?")
        if op:
            laptop_list.append(["GM Cricket Bat",1970,"1,970",Spaces(40-len("GM Cricket Bat"))])
    ...
    def AddS2():
        ...
        op=messagebox.askyesno("Purchase Confirmation","Are you sure that you want to add this item to the cart?")
        if op:
            laptop_list.append(["GTS Leather Ball",160,"160",Spaces(40-len("GTS Leather Ball"))])
    ...
    def AddS3():
        ...
        op=messagebox.askyesno("Purchase Confirmation","Are you sure that you want to add this item to the cart?")
        if op:
            laptop_list.append(["Yonex Badminton Racquet",550,"550",Spaces(40-len("Yonex Badminton Racquet"))])
    ...
    def AddS4():
        ...
        op=messagebox.askyesno("Purchase Confirmation","Are you sure that you want to add this item to the cart?")
        if op:
            laptop_list.append(["Strauss Shuttlecock",350,"350",Spaces(40-len("Strauss Shuttlecock"))])
    ...
    def AddS5():
        ...
        op=messagebox.askyesno("Purchase Confirmation","Are you sure that you want to add this item to the cart?")
        if op:
            laptop_list.append(["Table Tennis Kit",980,"980",Spaces(40-len("Table Tennis Kit"))])
    ...
    def AddS6():
        ...
        op=messagebox.askyesno("Purchase Confirmation","Are you sure that you want to add this item to the cart?")
        if op:
            laptop_list.append(["Cockatoo Treadmill",28990,"28,990",Spaces(40-len("Cockatoo Treadmill"))])
    ...
    def AddS7():
        ...
        op=messagebox.askyesno("Purchase Confirmation","Are you sure that you want to add this item to the cart?")
        if op:
            laptop_list.append(["Aurion Dumbbells",949,"949",Spaces(40-len("Aurion Dumbbells"))])
    ...
    def AddS8():
        ...
        op=messagebox.askyesno("Purchase Confirmation","Are you sure that you want to add this item to the cart?")
        if op:
            laptop_list.append(["Bench Press Machine",6799,"6,799",Spaces(40-len("Bench Press Machine"))])
    ...
    def AddS9():
        ...
        op=messagebox.askyesno("Purchase Confirmation","Are you sure that you want to add this item to the cart?")
        if op:
            laptop_list.append(["Reach Exercise Cycle",6999,"6,999",Spaces(40-len("Reach Exercise Cycle"))])
    ...
    def AddS10():
        ...
        op=messagebox.askyesno("Purchase Confirmation","Are you sure that you want to add this item to the cart?")
        if op:
            laptop_list.append(["RMOUR Punch Bag",2999,"2,999",Spaces(40-len("RMOUR Punch Bag"))])
    ...
    add_laptop4=Button(lf_laptop4,text="Add Item",bg="green",fg="white",font="times 9 bold",command=AddS4).place(x=120,y=210)
...
def SmartwatchCall():
    ...
    name_Smartwatch1=Label(lf_Smartwatch1,text="Julian Wood 2 Door Wardrobe",font="arial 9",justify="center").grid(row=1,column=0,padx=10)
    name_Smartwatch2=Label(lf_Smartwatch2,text="Zuari Niko Engineered Wood",font="arial 9",justify="center").grid(row=1,column=0)
    name_Smartwatch2=Label(lf_Smartwatch2,text="3 Door Wardrobe",font="arial 9",justify="center").grid(row=2,column=0)
    name_Smartwatch3=Label(lf_Smartwatch3,text="TADesign Vinicio Engineered",font="arial 9",justify="center").grid(row=1,column=0)
    name_Smartwatch3=Label(lf_Smartwatch3,text="Wood 3 Door Wardrobe",font="arial 9",justify="center").grid(row=2,column=0)
    name_Smartwatch4=Label(lf_Smartwatch4,text="Flipkart Perfect Homes Opus",font="arial 9",justify="center").grid(row=1,column=0)
    name_Smartwatch4=Label(lf_Smartwatch4,text="Engineered Wood",font="arial 9",justify="center").grid(row=2,column=0)
    name_Smartwatch4=Label(lf_Smartwatch4,text="Queen Box Bed",font="arial 9",justify="center").grid(row=3,column=0)
    ...
    price_Smartwatch1=Label(lf_Smartwatch1,text="Price: Rs.6,990",font="arial 9 bold").grid(row=2,column=0)
    price_Smartwatch2=Label(lf_Smartwatch2,text="Price: Rs.17,390",font="arial 9 bold").grid(row=3,column=0)
    price_Smartwatch3=Label(lf_Smartwatch3,text="Price: Rs.34,999",font="arial 9 bold").grid(row=3,column=0)
    price_Smartwatch4=Label(lf_Smartwatch4,text="Price: Rs.12,290",font="arial 9 bold").grid(row=4,column=0)
    ...
    def AddF1():
        ...
        op=messagebox.askyesno("Purchase Confirmation","Are you sure that you want to add this item to the cart?")
        if op:
            Smartwatch_list.append(["Julian 2 Door Wardrobe",6990,"6,990",Spaces(40-len("Julian 2 Door Wardrobe"))])
    ...
    def AddF2():
        ...
        op=messagebox.askyesno("Purchase Confirmation","Are you sure that you want to add this item to the cart?")
        if op:
            Smartwatch_list.append(["Zuari 3 Door Wardrobe",17390,"17,390",Spaces(40-len("Zuari 3 Door Wardrobe"))])
    ...
    def AddF3():
        ...
        op=messagebox.askyesno("Purchase Confirmation","Are you sure that you want to add this item to the cart?")
        if op:
            Smartwatch_list.append(["TADesign 3 Door Wardrobe",34999,"34,999",Spaces(40-len("TADesign 3 Door Wardrobe"))])
    ...
    def AddF4():
        ...
        op=messagebox.askyesno("Purchase Confirmation","Are you sure that you want to add this item to the cart?")
        if op:
            Smartwatch_list.append(["Opus Queen Box Bed",12290,"12,290",Spaces(40-len("Opus Queen Box Bed"))])
...
Smartwatch_button=Button(Button_frame,text="Smartwatchs",font="times 20 bold",width=15,bd=6,bg="#007185",fg="white",activebackground="light blue",command=SmartwatchCall)
